...
const changeYearColor = (url, sidePanelColor, mainPanelColor, responsiveUrl, textColor) => {
    ...
    const activityFilterContainer = document.querySelector('.activity-filter-container');
    const activityFilterOptions = document.querySelector('.activity-filter-options');
    ...
    activityFilterContainer.style.backgroundColor = sidePanelColor;
    activityFilterOptions.style.backgroundColor = sidePanelColor;
    activityFilterOptions.style.borderColor = mainPanelColor;
